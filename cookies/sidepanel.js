document.addEventListener("DOMContentLoaded", function () {
    ...
    const settingsButton = document.querySelector(".settings-button"); // Add this line
    ...
    if (encryptBtn) {
        encryptBtn.addEventListener("click", function () {
            alert("🔒 Encrypting Cookies (Mock Function)");
    ...
    if (decryptBtn) {
        decryptBtn.addEventListener("click", function () {
            alert("🔓 Decrypting Cookies (Mock Function)");
    ...
    // Redirect to Manage Cookies Page
    if (settingsButton) {
        settingsButton.addEventListener("click", function () {
            // Open the manage-cookies.html page in a new tab
            chrome.tabs.create({ url: chrome.runtime.getURL("manage-cookies.html") });
        });
    }
